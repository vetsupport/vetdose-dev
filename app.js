var SEED_DRUGS = [
  ...
  { id: 'espironolactona', generic: 'Espironolactona', trade: 'Aldactone', conc: 25, tabSizes: [25,50,100], doseMin: 2.0, doseMax: 2.0, dosePref: 2.0, unit: 'mg/kg', route: 'PO', category: 'cardiac/diuretic', formType: 'tablet', calcMode: 'standard', notes: 'Diurético ahorrador K+. Usar con IECA requiere monitoreo K+/renal.', source: 'Plumb 2024; Papich 2020', frequency: 'BID', frequencies: ['SID', 'BID'], validationStatus: 'Revisión preliminar; validar por usuario' },
